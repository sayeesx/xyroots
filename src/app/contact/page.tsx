      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-[#042816] via-[#074526] to-[#0a5c32] text-white py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-green-100/80 text-lg">We're here to help. Reach out and we'll respond within 24 hours.</p>
          </div>
        </section>
        ...
        <section className="py-16 bg-[#f7f8fa]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#042816] to-[#0a5c32] rounded-2xl p-5 text-white">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
                ...
                {sent ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button type="submit" className="w-full py-3.5 rounded-xl bg-gradient-to-br from-[#042816] to-[#0a5c32] text-white font-bold text-sm hover:shadow-lg transition-all">
                      Send Message
                    </button>
                  </form>
                )}
